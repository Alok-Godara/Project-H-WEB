...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Since this is a static demo, we'll simulate a successful submission
    setFormStatus({
      submitted: true,
      success: true,
            ...
            <div className="bg-white rounded-xl shadow-md p-8 h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:contact@ayubharat.in"
                      className="text-primary-600 hover:text-primary-700 transition-colors"
                    >
                      contact@ayubharat.in
                    </a>
                  </div>
                </div>

                <div className="flex items-start space-x-4">
                  <div className="p-2 bg-secondary-100 rounded-md text-secondary-600">
                    <MapPin className="h-5 w-5" />
                  </div>
                  <div>
                    <h4 className="font-medium text-slate-800 mb-1">Office</h4>
                    <p className="text-slate-600">
                      IIT Jodhpur Campus, Karwar
                      <br />
                ...
                <div className="flex items-start space-x-4">
                  <div className="p-2 bg-accent-100 rounded-md text-accent-600">
              ...
              <div className="mt-8 pt-6 border-t border-slate-100">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="p-2 bg-slate-100 hover:bg-primary-100 rounded-md text-slate-600 hover:text-primary-600 transition-colors"
                  >
                    <svg
                      className="h-5 w-5"
                      fill="currentColor"
